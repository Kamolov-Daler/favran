    ...
    <div className={styles.card} onClick={(e) => clickCard(e)}>
      <div className={bool ? styles.frontActive : styles.front}>
        <div className={classes.cardContainer}>
          ...
          <div className={classes.cardPrice}>
            <span style={{ textDecoration: "line-through" }}>{item.old_price}</span> / {item.new_price}
          </div>
      ...
      <div className={bool ? styles.backActive : styles.back}>
        <div className={classes.cardContainerBack}>
          {item.is_top ? <div className={classes.cardTopText}>товар в топе</div> : null}
          <div className={classes.cardInfo}>Сведенье:</div>
          <div className={classes.cardGoods}>Товар: {item.name}</div>
          <div className={classes.cardGoods}>Магазин: {item.shop_name}</div>
          <div className={classes.cardGoods}>Адрес магазина: {item.shop_address}</div>
          <div className={classes.cardGoods}>
            Телефон магазина:{" "}
            <a href={`tel:${item.shop_phone}`} onClick={(e) => e.stopPropagation()}>
              {item.shop_phone}
            </a>
          </div>
        </div>
